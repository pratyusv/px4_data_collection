...
struct HIGH_LATENCY2 : mavlink::Message {
    ...
    static constexpr uint8_t CRC_EXTRA = 136;
    ...
    inline void serialize(mavlink::MsgMap &map) const override
    {
        ...
        map << target_altitude;               // offset: 14
        map << target_distance;               // offset: 16
        map << wp_num;                        // offset: 18
        map << failure_flags;                 // offset: 20
        map << type;                          // offset: 22
        map << autopilot;                     // offset: 23
        map << flight_mode;                   // offset: 24
        map << heading;                       // offset: 25
        map << target_heading;                // offset: 26
        map << throttle;                      // offset: 27
        map << airspeed;                      // offset: 28
        map << airspeed_sp;                   // offset: 29
        map << groundspeed;                   // offset: 30
        map << windspeed;                     // offset: 31
        map << wind_heading;                  // offset: 32
        map << eph;                           // offset: 33
        map << epv;                           // offset: 34
        map << temperature_air;               // offset: 35
        map << climb_rate;                    // offset: 36
        map << battery;                       // offset: 37
