...
//! MAV_TYPE ENUM_END
constexpr auto MAV_TYPE_ENUM_END = 30;
...
enum class FLIGHT_MODE : uint8_t
{
    ...
    ALTCTL=1, /* Altitude hold flight mode | */
    POSCTL=2, /* Position control flight mode | */
    STABILIZED=3, /* Stabilized mode | */
    ACRO=4, /* Acro mode | */
    RATTITIDE=5, /* Rattitude mode | */
    AUTO_MISSION=6, /* Mission mode | */
    AUTO_LOITER=7, /* Loiter mode | */
    AUTO_RTL=8, /* Return to land mode | */
    AUTO_RCRECOVER=9, /* RC recover mode | */
    AUTO_RTGS=10, /* Return to ground station mode | */
    AUTO_LANDENGFAIL=11, /* Land Engine Fail mode | */
    AUTO_LANDGPSFAIL=12, /* Land GPS fail mode | */
    AUTO_TAKEOFF=13, /* Takeoff mode | */
    AUTO_LAND=14, /* Land mode | */
    AUTO_FOLLOW_TARGET=15, /* Follow target/me mode | */
    AUTO_PRECLAND=16, /* Precision landing mode | */
    DESCEND=17, /* Descend mode | */
    OFFBOARD=18, /* Offboard mode | */
    TERMINATION=19, /* Termination mode | */
    AUTO_TUNE=20, /* Auto tune mode | */
    BRAKE=21, /* Brake mode | */
    CIRCLE=22, /* Circle mode | */
    DRIFT=23, /* Drift mode | */
    GUIDED=24, /* Guided mode | */
    SPORT=25, /* Sport mode | */
    THROW=26, /* Throw mode | */
    SUPER_SIMPLE=27, /* Simplified multicopter control mode | */
    AVIOD_TRAFFIC=28, /* Avoid traffic mode | */
    FBWA=29, /* Fly by wire (version A) mode | */
    FBWB=30, /* Flz by wire (version B) mode | */
    TRAINING=31, /* Position control flight mode | */
    CRUISE=32, /* Cruise mode | */
    HOLD=33, /* Position hold mode | */
    STEERING=34, /* Steering mode | */
    SMART_RTL=35, /* Smart return-to-land-mode | */
};

//! FLIGHT_MODE ENUM_END
constexpr auto FLIGHT_MODE_ENUM_END = 36;

/** @brief These flags encode if a certain failsafe mode is triggered. */
enum class MAV_FAILSAFE_FLAG : uint8_t
{
    RESERVED2=1, /* 0b00000001 Reserved for future use. | */
    RESERVED1=2, /* 0b00000010 Reserved for future use. | */
    GEOFENCE=4, /* 0b00000100 Geofence failsafe active. | */
    BATTERY=8, /* 0b00001000 Battery failure failsafe active. | */
    GPS=16, /* 0b00010000 GPS failure failsafe active. | */
    ENGINE=32, /* 0b00100000 Engine failure failsafe active. | */
    TELEM_LOSS=64, /* 0b01000000 remote control input is enabled. | */
    RC_LOSS=128, /* 0b10000000 RC loss failsafe active. | */
};

//! MAV_FAILSAFE_FLAG ENUM_END
constexpr auto MAV_FAILSAFE_FLAG_ENUM_END = 129;

/** @brief These flags encode if a certain failsafe mode is triggered. */
enum class MAV_FAILURE_FLAG : uint16_t
{
    GPS=1, /* GPS failure. | */
    AIRSPEED=2, /* Airspeed failure. | */
    BAROMETER=4, /* Barometer failure. | */
    ACCELEROMETER=8, /* Accelerometer failure. | */
    GYROSCOPE=16, /* Gyroscope failure. | */
    MAGNETOMETER=32, /* Magnetometer. | */
    MISSION=64, /* Mission failure. | */
    ESTIMATOR=128, /* Estimator failure. | */
    LIDAR=256, /* Lidar failure. | */
    OFFBOARD_LINK=512, /* Offboard link failure. | */
    RESERVED1=1024, /* Reserved for future use. | */
    RESERVED2=2048, /* Reserved for future use. | */
    RESERVED3=4096, /* Reserved for future use. | */
    RESERVED4=8192, /* Reserved for future use. | */
    RESERVED5=16384, /* Reserved for future use. | */
    RESERVED6=32768, /* Reserved for future use. | */
};

//! MAV_FAILURE_FLAG ENUM_END
constexpr auto MAV_FAILURE_FLAG_ENUM_END = 32769;
...
#include "./mavlink_msg_lqr_controls.hpp"
