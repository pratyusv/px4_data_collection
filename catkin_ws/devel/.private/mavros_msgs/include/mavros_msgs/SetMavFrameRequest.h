...
struct SetMavFrameRequest_
{
  ...
  _mav_frame_type mav_frame;
    ...
    enum { FRAME_GLOBAL = 0u };
     ...
     enum { FRAME_GLOBAL_RELATIVE_ALT = 3u };
     enum { FRAME_LOCAL_ENU = 4u };
     enum { FRAME_GLOBAL_INT = 5u };
     enum { FRAME_GLOBAL_RELATIVE_ALT_INT = 6u };
     enum { FRAME_LOCAL_OFFSET_NED = 7u };
     enum { FRAME_BODY_NED = 8u };
     enum { FRAME_BODY_OFFSET_NED = 9u };
     enum { FRAME_GLOBAL_TERRAIN_ALT = 10u };
     enum { FRAME_GLOBAL_TERRAIN_ALT_INT = 11u };
...
// {'geographic_msgs': ['/opt/ros/kinetic/share/geographic_msgs/cmake/../msg'], 'sensor_msgs': ['/opt/ros/kinetic/share/sensor_msgs/cmake/../msg'], 'std_msgs': ['/opt/ros/kinetic/share/std_msgs/cmake/../msg'], 'mavros_msgs': ['/home/pratyush/git/px4_data_collection/catkin_ws/src/mavros/mavros_msgs/msg'], 'geometry_msgs': ['/opt/ros/kinetic/share/geometry_msgs/cmake/../msg'], 'uuid_msgs': ['/opt/ros/kinetic/share/uuid_msgs/cmake/../msg']}
