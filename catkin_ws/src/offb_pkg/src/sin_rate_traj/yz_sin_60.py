...
def control():
	...
	np.save('nn1_60_sin_yz_input_state.npy',nn1_yz_input_state)
	np.save('nn1_60_sin_yz_grd_truth.npy',nn1_yz_grd_truth)
	np.save('nn2_60_sin_yz_input_state.npy',nn2_yz_input_state)
	np.save('nn2_60_sin_yz_grd_truth.npy',nn2_yz_grd_truth)
	...
	np.save('s_60_yz_sin.npy' ,s_yz_sin)
	np.save('u_60_yz_sin.npy' ,u_yz_sin)
