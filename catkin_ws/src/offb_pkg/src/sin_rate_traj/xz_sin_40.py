...
def control():
	...
	np.save('nn1_40_sin_xz_input_state.npy',nn1_xz_input_state)
	np.save('nn1_40_sin_xz_grd_truth.npy',nn1_xz_grd_truth)
	np.save('nn2_40_sin_xz_input_state.npy',nn2_xz_input_state)
	np.save('nn2_40_sin_xz_grd_truth.npy',nn2_xz_grd_truth)
	...
	np.save('s_40_xz_sin.npy' ,s_xz_sin)
	np.save('u_40_xz_sin.npy' ,u_xz_sin)
