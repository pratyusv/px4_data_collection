...
def control():
	...
	np.save('nn1_80_sin_xy_input_state.npy',nn1_xy_input_state)
	np.save('nn1_80_sin_xy_grd_truth.npy',nn1_xy_grd_truth)
	np.save('nn2_80_sin_xy_input_state.npy',nn2_xy_input_state)
	np.save('nn2_80_sin_xy_grd_truth.npy',nn2_xy_grd_truth)
	...
	np.save('s_80_xy_sin.npy' ,s_xy_sin)
	np.save('u_80_xy_sin.npy' ,u_xy_sin)
