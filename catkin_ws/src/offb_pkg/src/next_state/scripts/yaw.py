...
def control():
	...
	while not rospy.is_shutdown():
		...
		if flag1 and flag2:
			...
			(roll,pitch, yaw) = quaternion_to_euler_angle(pose.pose.orientation.w,0,0 ,pose.pose.orientation.z)
	...
	s_yaw = np.array([x_f, y_f, z_f,vx_f,vy_f,vz_f,sin_r_f,sin_p_f,sin_y_f,cos_r_f,cos_p_f,cos_y_f,rs_f,ps_f,ys_f,r_f,p_f,yaw_f],ndmin=2).transpose()
