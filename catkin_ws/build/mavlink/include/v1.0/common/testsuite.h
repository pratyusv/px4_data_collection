...
static void mavlink_test_lqr_controls(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_LQR_CONTROLS >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
    mavlink_lqr_controls_t packet_in = {
        17.0,45.0,73.0,101.0,129.0,157.0,185.0
    };
    mavlink_lqr_controls_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.roll_moment = packet_in.roll_moment;
        packet1.pitch_moment = packet_in.pitch_moment;
        packet1.yaw_moment = packet_in.yaw_moment;
        packet1.thrust_moment = packet_in.thrust_moment;
        ...
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_LQR_CONTROLS_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_LQR_CONTROLS_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_lqr_controls_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_lqr_controls_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_lqr_controls_pack(system_id, component_id, &msg , packet1.roll_moment , packet1.pitch_moment , packet1.yaw_moment , packet1.thrust_moment , packet1.roll_angle , packet1.pitch_angle , packet1.yaw_angle );
    mavlink_msg_lqr_controls_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_lqr_controls_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.roll_moment , packet1.pitch_moment , packet1.yaw_moment , packet1.thrust_moment , packet1.roll_angle , packet1.pitch_angle , packet1.yaw_angle );
    mavlink_msg_lqr_controls_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_lqr_controls_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_lqr_controls_send(MAVLINK_COMM_1 , packet1.roll_moment , packet1.pitch_moment , packet1.yaw_moment , packet1.thrust_moment , packet1.roll_angle , packet1.pitch_angle , packet1.yaw_angle );
    mavlink_msg_lqr_controls_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}
...
static void mavlink_test_high_latency2(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
    ...
    mavlink_high_latency2_t packet_in = {
        963497464,963497672,963497880,17859,17963,18067,18171,18275,199,10,77,144,211,22,89,156,223,34,101,168,235,46,113,180,247,58,125,192
    };
    ...
    mavlink_msg_high_latency2_decode(&msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_high_latency2_pack(system_id, component_id, &msg , packet1.timestamp , packet1.type , packet1.autopilot , packet1.flight_mode , packet1.latitude , packet1.longitude , packet1.altitude , packet1.target_altitude , packet1.heading , packet1.target_heading , packet1.target_distance , packet1.throttle , packet1.airspeed , packet1.airspeed_sp , packet1.groundspeed , packet1.windspeed , packet1.wind_heading , packet1.eph , packet1.epv , packet1.temperature_air , packet1.climb_rate , packet1.battery , packet1.wp_num , packet1.failure_flags , packet1.failsafe , packet1.custom0 , packet1.custom1 , packet1.custom2 );
    mavlink_msg_high_latency2_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
...
static void mavlink_test_common(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
    ...
    mavlink_test_lqr_controls(system_id, component_id, last_msg);
