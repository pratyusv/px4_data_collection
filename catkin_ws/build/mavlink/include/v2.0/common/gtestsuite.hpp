...
TEST(common, LQR_CONTROLS)
{
    mavlink::mavlink_message_t msg;
    mavlink::MsgMap map1(msg);
    mavlink::MsgMap map2(msg);

    mavlink::common::msg::LQR_CONTROLS packet_in{};
    packet_in.roll_moment = 17.0;
    packet_in.pitch_moment = 45.0;
    packet_in.yaw_moment = 73.0;
    packet_in.thrust_moment = 101.0;
    packet_in.roll_angle = 129.0;
    packet_in.pitch_angle = 157.0;
    packet_in.yaw_angle = 185.0;

    mavlink::common::msg::LQR_CONTROLS packet1{};
    mavlink::common::msg::LQR_CONTROLS packet2{};
    ...
    EXPECT_EQ(packet1.roll_moment, packet2.roll_moment);
    EXPECT_EQ(packet1.pitch_moment, packet2.pitch_moment);
    EXPECT_EQ(packet1.yaw_moment, packet2.yaw_moment);
    EXPECT_EQ(packet1.thrust_moment, packet2.thrust_moment);
...
#ifdef TEST_INTEROP
TEST(common_interop, LQR_CONTROLS)
{
    mavlink_message_t msg;
    ...
    mavlink_lqr_controls_t packet_c {
    ...
    mavlink_msg_lqr_controls_encode(1, 1, &msg, &packet_c);
    ...
    EXPECT_EQ(packet_in.roll_moment, packet2.roll_moment);
    EXPECT_EQ(packet_in.pitch_moment, packet2.pitch_moment);
    EXPECT_EQ(packet_in.yaw_moment, packet2.yaw_moment);
    EXPECT_EQ(packet_in.thrust_moment, packet2.thrust_moment);
...
TEST(common, HIGH_LATENCY2)
{
    ...
    packet_in.type = 199;
    packet_in.autopilot = 10;
    packet_in.flight_mode = 77;
    packet_in.latitude = 963497672;
    packet_in.longitude = 963497880;
    packet_in.altitude = 17859;
    packet_in.target_altitude = 17963;
    packet_in.heading = 144;
    packet_in.target_heading = 211;
    packet_in.target_distance = 18067;
    packet_in.throttle = 22;
    packet_in.airspeed = 89;
    packet_in.airspeed_sp = 156;
    packet_in.groundspeed = 223;
    packet_in.windspeed = 34;
    packet_in.wind_heading = 101;
    packet_in.eph = 168;
    packet_in.epv = 235;
    packet_in.temperature_air = 46;
    packet_in.climb_rate = 113;
    packet_in.battery = -76;
    packet_in.wp_num = 18171;
    packet_in.failure_flags = 18275;
    packet_in.failsafe = 247;
...
TEST(common_interop, HIGH_LATENCY2)
{
    ...
    mavlink_high_latency2_t packet_c {
         963497464, 963497672, 963497880, 17859, 17963, 18067, 18171, 18275, 199, 10, 77, 144, 211, 22, 89, 156, 223, 34, 101, 168, 235, 46, 113, -76, 247, 58, 125, -64
    };
